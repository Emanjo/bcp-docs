...
h| Request URL
| `pass:[https://bcp.example.com/api/v1/[..]]`
|===
...
h| Request URL
| `pass:[https://example.com/bcp/api/v1/[..]]`
|===
...
<3> One or more process identifiers and roles identifying supported processes.
...
|===
| API path
| `/api/v1/[ParticipantID]/[ProcessID](/[RoleID])(/[Date])`
...
|===
| API path
| `/api/v1/[ParticipantID]/[ProcessID](/[RoleID])/historic`
